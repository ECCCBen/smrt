# -*- coding: utf-8 -*-
#
# SMRT documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'SMRT.tex', u'SMRT Documentation',
     u'G. Picard, M. Sandells, H. Löwe', 'manual'),
]
